...
class ResidualMambaBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        mamba_out2 = self.mamba_transformer(mamba_out2)
        #mamba_out2 = self.mamba_transformer(mamba_out2)
        #mamba_out2 = self.mamba_transformer(mamba_out2)

        mamba_out3 = self.mamba_transformer(out3)
        mamba_out3 = self.mamba_transformer(mamba_out3)
        #mamba_out3 = self.mamba_transformer(mamba_out3)
        #mamba_out3 = self.mamba_transformer(mamba_out3)

        mamba_out4 = self.mamba_transformer(out4)
        mamba_out4 = self.mamba_transformer(mamba_out4)
        #mamba_out4 = self.mamba_transformer(mamba_out4)
        #mamba_out4 = self.mamba_transformer(mamba_out4)
        ...
        # Merge all outputs
        merged = mamba_out1 + mamba_out2 + mamba_out3 + mamba_out4 
...
if __name__ == '__main__':
    model = Model_MTA2(in_ch=9, out_ch=1,
