...
class ChannelSpatialSELayer3D(nn.Module):
    ...
    def __init__(self, num_channels, reduction_ratio=2):
        ...
        self.alpha = nn.Parameter(torch.ones(1))  # Initialized to 1
    ...
    def forward(self, input_tensor):
        ...
        :return: output_tensor
        """
        channel_attention = self.cSE(input_tensor)
        spatial_attention = self.sSE(input_tensor)


        output_tensor = self.alpha * channel_attention + self.beta * spatial_attention
